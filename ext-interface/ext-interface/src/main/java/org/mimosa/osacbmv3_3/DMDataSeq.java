...
/**
 * <p>Java class for DMDataSeq complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DMDataSeq">
 *   &lt;complexContent>
...
@XmlType(name = "DMDataSeq", propOrder = {
    "values",
    "valuesList",
    "valuesBinary",
    "xAxisDeltas",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DMDataSeq)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DMDataSeq that = ((DMDataSeq) object);
        {
