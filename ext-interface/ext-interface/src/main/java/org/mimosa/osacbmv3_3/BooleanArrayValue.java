...
/**
 * <p>Java class for BooleanArrayValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BooleanArrayValue">
 *   &lt;complexContent>
...
@XmlType(name = "BooleanArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BooleanArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final BooleanArrayValue that = ((BooleanArrayValue) object);
        {
            List<Boolean> lhsValues;
            lhsValues = (((this.values!= null)&&(!this.values.isEmpty()))?this.getValues():null);
            List<Boolean> rhsValues;
