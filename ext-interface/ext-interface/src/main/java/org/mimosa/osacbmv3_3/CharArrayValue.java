...
/**
 * <p>Java class for CharArrayValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CharArrayValue">
 *   &lt;complexContent>
...
@XmlType(name = "CharArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CharArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final CharArrayValue that = ((CharArrayValue) object);
        {
