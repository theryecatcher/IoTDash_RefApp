...
/**
 * <p>Java class for RealWaveform complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RealWaveform">
 *   &lt;complexContent>
...
@XmlType(name = "RealWaveform", propOrder = {
    "realValues",
    "realValuesList",
    "realValuesBinary",
    "xAxisDelta",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RealWaveform)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final RealWaveform that = ((RealWaveform) object);
        {
