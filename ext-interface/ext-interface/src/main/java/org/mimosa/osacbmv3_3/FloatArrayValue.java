...
/**
 * <p>Java class for FloatArrayValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FloatArrayValue">
 *   &lt;complexContent>
...
@XmlType(name = "FloatArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FloatArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final FloatArrayValue that = ((FloatArrayValue) object);
        {
            List<Float> lhsValues;
            lhsValues = (((this.values!= null)&&(!this.values.isEmpty()))?this.getValues():null);
            List<Float> rhsValues;
