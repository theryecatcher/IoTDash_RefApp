...
/**
 * <p>Java class for ControlRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ControlRequest">
 *   &lt;complexContent>
...
@XmlType(name = "ControlRequest", propOrder = {
    "parameters"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ControlRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ControlRequest that = ((ControlRequest) object);
        {
