...
/**
 * <p>Java class for DADataEvent complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DADataEvent">
 *   &lt;complexContent>
...
@XmlType(name = "DADataEvent", propOrder = {
    "dataStatus",
    "numAlerts"
})
@XmlSeeAlso({
    DAWaveform.class,
    DAValueDataSeq.class,
    DAReal.class,
    DAValueWaveform.class,
    DADataSeq.class,
    DAString.class,
    DABool.class,
    DABLOBData.class,
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DADataEvent)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DADataEvent that = ((DADataEvent) object);
        {
