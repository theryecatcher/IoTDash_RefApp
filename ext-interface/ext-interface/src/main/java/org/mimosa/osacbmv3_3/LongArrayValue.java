...
/**
 * <p>Java class for LongArrayValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LongArrayValue">
 *   &lt;complexContent>
...
@XmlType(name = "LongArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LongArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final LongArrayValue that = ((LongArrayValue) object);
        {
            List<Long> lhsValues;
