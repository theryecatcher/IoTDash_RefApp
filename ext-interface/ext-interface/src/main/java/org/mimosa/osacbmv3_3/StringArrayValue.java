...
/**
 * <p>Java class for StringArrayValue complex type.
 * 
...
@XmlType(name = "StringArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof StringArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final StringArrayValue that = ((StringArrayValue) object);
        {
