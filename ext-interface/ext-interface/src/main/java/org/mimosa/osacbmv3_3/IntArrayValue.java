...
/**
 * <p>Java class for IntArrayValue complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="IntArrayValue">
 *   &lt;complexContent>
...
@XmlType(name = "IntArrayValue", propOrder = {
    "values"
})
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof IntArrayValue)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final IntArrayValue that = ((IntArrayValue) object);
        {
            List<Integer> lhsValues;
            lhsValues = (((this.values!= null)&&(!this.values.isEmpty()))?this.getValues():null);
            List<Integer> rhsValues;
