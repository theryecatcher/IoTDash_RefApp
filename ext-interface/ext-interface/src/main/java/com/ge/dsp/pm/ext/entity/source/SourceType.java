 ...
 *       &lt;sequence>
 *         &lt;element name="sourceTypeEnum" type="{http://dsp.ge.com/pm/ext/entity/source}SourceTypeEnum"/>
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            SourceTypeEnum theSourceTypeEnum;
            theSourceTypeEnum = this.getSourceTypeEnum();
            strategy.appendField(locator, this, "sourceTypeEnum", buffer, theSourceTypeEnum);
        }
        {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            SourceTypeEnum lhsSourceTypeEnum;
            lhsSourceTypeEnum = this.getSourceTypeEnum();
            SourceTypeEnum rhsSourceTypeEnum;
            rhsSourceTypeEnum = that.getSourceTypeEnum();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sourceTypeEnum", lhsSourceTypeEnum), LocatorUtils.property(thatLocator, "sourceTypeEnum", rhsSourceTypeEnum), lhsSourceTypeEnum, rhsSourceTypeEnum)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        int currentHashCode = 1;
        {
            SourceTypeEnum theSourceTypeEnum;
            theSourceTypeEnum = this.getSourceTypeEnum();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sourceTypeEnum", theSourceTypeEnum), currentHashCode, theSourceTypeEnum);
        }
        {
            String theOtherValue;
            theOtherValue = this.getOtherValue();
