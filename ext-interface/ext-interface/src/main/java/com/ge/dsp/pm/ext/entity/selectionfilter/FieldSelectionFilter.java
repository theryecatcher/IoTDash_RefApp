...
/**
 * <p>Java class for FieldSelectionFilter complex type.
 * 
 ...
 *         &lt;element name="operator" type="{http://dsp.ge.com/pm/ext/entity/selectionfilter}OperatorEnum" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "FieldSelectionFilter", propOrder = {
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FieldSelectionFilter)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final FieldSelectionFilter that = ((FieldSelectionFilter) object);
        {
