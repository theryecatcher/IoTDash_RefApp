...
/**
 * <p>Java class for FieldIdentifierValue complex type.
 * 
...
@XmlType(name = "FieldIdentifierValue", propOrder = {
    "fieldIdentifier",
    "value"
})
public class FieldIdentifierValue
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FieldIdentifierValue)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FieldIdentifierValue that = ((FieldIdentifierValue) object);
        {
