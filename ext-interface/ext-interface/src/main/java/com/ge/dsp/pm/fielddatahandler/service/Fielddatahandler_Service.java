...
public class Fielddatahandler_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/media/sf_GitRepos/InfyIoTDash_RefApp/ext-interface/ext-interface/src/main/resources/META-INF/schemas/pm/service/wsdl/fielddatahandler.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Fielddatahandler_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/media/sf_GitRepos/InfyIoTDash_RefApp/ext-interface/ext-interface/src/main/resources/META-INF/schemas/pm/service/wsdl/fielddatahandler.wsdl");
        }
        WSDL_LOCATION = url;
    }
