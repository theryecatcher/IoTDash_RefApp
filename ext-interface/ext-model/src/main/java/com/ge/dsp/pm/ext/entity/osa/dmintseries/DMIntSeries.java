 ...
 * 				
 * 
 * <p>Java class for DMIntSeries complex type.
 * 
 ...
 *           &lt;element name="valuesList" type="{http://dsp.ge.com/aaas/entity/xmllist}ListOfInteger" minOccurs="0"/>
 ...
 *           &lt;element name="xAxisOffsetsList" type="{http://dsp.ge.com/aaas/entity/xmllist}ListOfInteger" minOccurs="0"/>
...
@XmlType(name = "DMIntSeries", propOrder = {
    "xAxisStart",
    "values",
    "valuesList",
    "valuesBinary",
    ...
    implements Serializable, Equals, HashCode, ToString
{
    ...
    @XmlList
    protected List<BigInteger> valuesList;
    protected List<byte[]> valuesBinary;
    @XmlElement(type = Double.class)
    protected List<Double> xAxisOffsets;
    @XmlList
    protected List<BigInteger> xAxisOffsetsList;
    ...
    public List<BigInteger> getValuesList() {
        if (valuesList == null) {
            valuesList = new ArrayList<BigInteger>();
        }
     ...
     * 
     */
    public List<BigInteger> getXAxisOffsetsList() {
        if (xAxisOffsetsList == null) {
            xAxisOffsetsList = new ArrayList<BigInteger>();
        }
     ...
     *     
     */
    public void setValuesList(List<BigInteger> valuesList) {
     ...
     *     
     */
    public void setXAxisOffsetsList(List<BigInteger> xAxisOffsetsList) {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            List<BigInteger> theXAxisOffsetsList;
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DMIntSeries)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final DMIntSeries that = ((DMIntSeries) object);
        {
