...
@XmlRootElement(name = "selectionFilterRoot")
public class SelectionFilterRoot
    implements Serializable, Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof SelectionFilterRoot)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final SelectionFilterRoot that = ((SelectionFilterRoot) object);
        {
