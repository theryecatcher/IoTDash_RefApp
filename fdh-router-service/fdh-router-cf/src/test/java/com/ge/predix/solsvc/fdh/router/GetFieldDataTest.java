...
import com.ge.predix.solsvc.bootstrap.tbs.dto.datapoints.response.Result;
...
public class GetFieldDataTest extends BaseTest {
            ...
            throws IOException, JAXBException, HttpException
    {
        ...
        com.ge.predix.solsvc.bootstrap.tbs.dto.datapoints.response.Tag tag = new com.ge.predix.solsvc.bootstrap.tbs.dto.datapoints.response.Tag();
        List<com.ge.predix.solsvc.bootstrap.tbs.dto.datapoints.response.Tag> tags= new ArrayList<com.ge.predix.solsvc.bootstrap.tbs.dto.datapoints.response.Tag>();
