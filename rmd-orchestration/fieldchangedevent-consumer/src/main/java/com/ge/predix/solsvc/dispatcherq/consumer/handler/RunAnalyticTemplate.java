...
public class RunAnalyticTemplate
{
            ...
            String assetUriName, String assetUriValue, FieldIdentifier assetIdFieldIdentifier)
    {
        ...
        String outputPort1Field = portFieldName + "/meterDatasource/meterExtensions/attributes/alertStatus/value";
        ...
        String outputPort2Field = portFieldName + "/meterDatasource/meterExtensions/attributes/alertLevel/value";
        ...
        String outputPort3Field = portFieldName + "/meterDatasource/meterExtensions/attributes/alertLevelValue/value";
        ...
        String outputPort4Field = portFieldName + "/meterDatasource/meterExtensions/attributes/alertTime/value";
        ...
        String outputPort5Field = portFieldName + "/meterDatasource/meterExtensions/attributes/deltaThreshold/value";
        ...
        String outputPort6Field = portFieldName
                + "/meterDatasource/meterExtensions/attributes/deltaThresholdLevel/value";
    ...
    private static Port createPort(String portId, String portName, String field, String fieldSource,
            String expectedDataType, SelectionFilter selectionFilter)
    {
        Port aPort = new Port();
