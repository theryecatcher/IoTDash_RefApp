...
public class OrchestrationRestCloudConfig  implements EnvironmentAware, IOrchestrationRestConfig
{
    ...
    @Value("${predix_orchestration_restPort:9093}")
    ...
    {
        return this.orchRestProtocol + "://" + this.orchRestHost + ":" + this.orchRestPort + "/" + this.orchRestBaseResource;
    }
    ...
    {
        return this.analyticRestProtocol + "://" + this.analyticRestHost + ":" + this.analyticRestPort + "/" + this.analyticRestBaseResource;
    }
