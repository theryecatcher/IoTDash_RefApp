...
@SpringApplicationConfiguration(classes = {FdhRouterApplication.class, RefAppAnalyticApplication.class})
@WebAppConfiguration
...
public class RefAppAnalyticIT
{
    ...
    public void testRefAssetAnalytic()
    {
        ...
        List<Model> models = this.modelFactory.getModels("/asset/compressor-2015.meter-extensions.crank-frame-discharge-pressure", "Asset", headers);
        ((Asset) models.get(0)).getAttributes().get("alertStatus").getValue().set(0, true);
        this.modelFactory.updateModel(models.get(0), "Asset", headers);


        CloseableHttpResponse httpResponse = this.restClient.post(this.refappAnalyticEndpoint,
                analyticRequest, headers);
        ...
        models = this.modelFactory.getModels("/asset/compressor-2015.meter-extensions.crank-frame-discharge-pressure", "Asset", headers);
        Assert.assertFalse((Boolean) ((Asset) models.get(0)).getAttributes().get("alertStatus").getValue().get(0));
    ...
    private RunAnalyticRequest getRunAnalyticRequestTestData()
    {
        ...
        String port1Field = "/asset/assetMeter/crank-frame-dischargepressure/outputMaximum";
        ...
        String port2Field = "/asset/assetMeter/crank-frame-dischargepressure/outputMinimum";
        ...
        String port3Field = "/asset/assetMeter/crank-frame-dischargepressure";
        ...
        String outputPort1Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/alertStatus/value";
        ...
        String outputPort2Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/alertLevel/value";
        ...
        String outputPort3Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/alertLevelValue/value";
        ...
        String outputPort4Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/alertTime/value";
        ...
        String outputPort5Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/deltaThreshold/value";
        ...
        String outputPort6Field = "/asset/assetMeter/crank-frame-dischargepressure/meterDatasource/meterExtensions/attributes/deltaThresholdLevel/value";
     ...
     * @return -
     */
    private SelectionFilter getTimeseriesFieldSelectionFilter(String assetUriField, String assetUriValue,
